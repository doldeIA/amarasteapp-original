# 1. Criar pasta caso não exista
mkdir -p src/components

# 2. Criar o arquivo MainControls.tsx com conteúdo correto
cat > src/components/MainControls.tsx <<'EOF'
...
git add src/components/MainControls.tsx
git commit -m "feat: adiciona MainControls.tsx funcional"
